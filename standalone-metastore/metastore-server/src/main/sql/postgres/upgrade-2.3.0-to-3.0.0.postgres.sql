...
CREATE INDEX IF NOT EXISTS "CONSTRAINTS_CONSTRAINT_TYPE_INDEX" ON "KEY_CONSTRAINTS" USING BTREE ("CONSTRAINT_TYPE");
...
ALTER TABLE "PART_COL_STATS" ADD COLUMN IF NOT EXISTS "BIT_VECTOR" BYTEA;
ALTER TABLE "TAB_COL_STATS" ADD COLUMN IF NOT EXISTS "BIT_VECTOR" BYTEA;
...
ALTER TABLE "SERDES" ADD COLUMN IF NOT EXISTS "DESCRIPTION" VARCHAR(4000);
ALTER TABLE "SERDES" ADD COLUMN IF NOT EXISTS "SERIALIZER_CLASS" VARCHAR(4000);
ALTER TABLE "SERDES" ADD COLUMN IF NOT EXISTS "DESERIALIZER_CLASS" VARCHAR(4000);
ALTER TABLE "SERDES" ADD COLUMN IF NOT EXISTS "SERDE_TYPE" INTEGER;
...
CREATE INDEX IF NOT EXISTS "MV_UNIQUE_TABLE"
...
ALTER TABLE COMPLETED_TXN_COMPONENTS ADD COLUMN IF NOT EXISTS CTC_TIMESTAMP timestamp NULL;

ALTER TABLE "TBLS" ADD COLUMN IF NOT EXISTS "OWNER_TYPE" character varying(10) DEFAULT NULL::character varying;
...
CREATE INDEX IF NOT EXISTS COMPLETED_TXN_COMPONENTS_INDEX ON COMPLETED_TXN_COMPONENTS USING btree (CTC_DATABASE, CTC_TABLE, CTC_PARTITION);
...
ALTER TABLE TXN_COMPONENTS ADD IF NOT EXISTS TC_WRITEID bigint;
ALTER TABLE COMPLETED_TXN_COMPONENTS ADD IF NOT EXISTS CTC_WRITEID bigint;

-- HIVE-18726
-- add a new column to support default value for DEFAULT constraint
ALTER TABLE "KEY_CONSTRAINTS" ADD COLUMN IF NOT EXISTS "DEFAULT_VALUE" VARCHAR(400);
...
ALTER TABLE "TAB_COL_STATS" ADD IF NOT EXISTS "CAT_NAME" varchar(256);
ALTER TABLE "PART_COL_STATS" ADD IF NOT EXISTS "CAT_NAME" varchar(256);
...
CREATE INDEX IF NOT EXISTS "PCS_STATS_IDX" ON "PART_COL_STATS" ("CAT_NAME", "DB_NAME", "TABLE_NAME", "COLUMN_NAME", "PARTITION_NAME");

-- ADD COLUMN IF NOT EXISTS to partition event
ALTER TABLE "PARTITION_EVENTS" ADD IF NOT EXISTS "CAT_NAME" varchar(256);
UPDATE "PARTITION_EVENTS"
  SET "CAT_NAME" = 'hive' WHERE "DB_NAME" IS NOT NULL;

-- ADD COLUMN IF NOT EXISTS to notification log
ALTER TABLE "NOTIFICATION_LOG" ADD IF NOT EXISTS "CAT_NAME" varchar(256);
...
CREATE INDEX IF NOT EXISTS MIN_HISTORY_LEVEL_IDX ON MIN_HISTORY_LEVEL (MHL_MIN_OPEN_TXNID);
...
CREATE INDEX IF NOT EXISTS IDX_RUNTIME_STATS_CREATE_TIME ON RUNTIME_STATS (CREATE_TIME);
